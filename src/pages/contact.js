...
const ContactUs = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      if (mobVer) {
        // alert('Success');
        await axios
          .post(`${process.env.REACT_APP_BACKEND_LINK}/forms/sendMessage`, {
            formData,
          })
          .then((result) => {
  ...
  return (
    <>
      <Helmet>
<title>Contact us | Diploma certificate courses | Signet institute Australia</title>
<meta name='description' content='Have a query? Contact Us: ☎️1300 2233 12 | 📧 info@signet.edu.au | 📍Level 5 & 9, 341-345 Queen Street, Melbourne VIC 3000'data-rh="true" />
</Helmet>
      <NewHeader />
          ...
          <div className="sub-banner-text pt-80">
            <div className="row align-items-center">
              <div className="col-md-6 banner-sub-text-one">
                <h4 className="banner-sub-ttile">{contact.banner.title}</h4>
          ...
          <div className="row align-items-center">
            <div className="col-lg-12 text-center">
              <div className="contact-info-wrap rmb-75 wow fadeInUp delay-0-2s">
                ...
                <p>{contact.ourBranches.description} </p>
                    ...
                    <div className="row" id="melbourne">
                      <div className="col-md-6">
                        <div className="contact-info-box">
                          ...
                          <p>
                            <a href="tel:1300223312">1300 22 33 12</a>
                          </p>
                          <p>
                            <a href="tel:03 8638 9956">
                              {contact.melbourne.phone}
                            </a>
                          </p>
                          <p>
                            <a href="mailto:info@signet.edu.au">
                              {contact.melbourne.email}
                            </a>
                          </p>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="contact-info-box">
                          <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d581.8947512503314!2d144.95736727100058!3d-37.81026510155278!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad65daf441a8ed5%3A0xa7301f49fc8ca76f!2sSignet%20Institute%20of%20Australia%20(Melbourne)!5e0!3m2!1sen!2sin!4v1687779547669!5m2!1sen!2sin"
                            width="600"
                            height="312"
                            style={{ border: 0 }}
                            allowfullscreen=""
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <div className="contact-info-box">
                          ...
                          <p>
                            <a href="tel:02 7804 6980">
                              {contact.sydney.phone}
                            </a>
                          </p>
                          <p>
                            <a href="mailto:info@signet.edu.au">
                              {contact.sydney.email}
                            </a>
                          </p>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="contact-info-box">
                          <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6624.359097766504!2d151.1734633935791!3d-33.8850294!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6b12afbafe0a558b%3A0xf2204aae84cc8b5!2sSignet%20Institute%20of%20Australia%20(Sydney)!5e0!3m2!1sen!2sin!4v1687780159192!5m2!1sen!2sin"
                            width="600"
                            height="312"
                            style={{ border: 0 }}
                            allowfullscreen=""
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <div className="contact-info-box">
                          ...
                          <p>
                            <a href="tel:08 8220 1008">
                              {contact.adelaide.phone}
                            </a>
                          </p>
                          <p>
                            <a href="mailto:info@signet.edu.au">
                              {contact.adelaide.email}
                            </a>
                          </p>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="contact-info-box">
                          <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3271.2765948046526!2d138.59881167564222!3d-34.92459947284099!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ab0cf597e5fd167%3A0xb9dcbfe4bb6737bc!2sSignet%20Institute%20of%20Australia%20(Adelaide)!5e0!3m2!1sen!2sin!4v1687780066061!5m2!1sen!2sin"
                            width="600"
                            height="312"
                            style={{ border: 0 }}
                            allowfullscreen=""
