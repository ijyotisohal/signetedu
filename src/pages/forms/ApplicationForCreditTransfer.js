...
const ApplicationForCreditTransfer = () => {
  ...
  if (!translations) {
    return    <Loading/>; // Show loading state while translations are being fetched
  }
  ...
  return (
    <>
      <Helmet>
<title>Application for Credit Transfer - Signet Institute of Australia</title>
<meta name='description' content='Maximize your prior learning and educational achievements by applying for credit transfer at Signet Institute of Australia.'data-rh="true" />
</Helmet>
    <NewHeader/>
    <div className="sub-course-banner pt--60">
       ...
       <div className="sub-banner-text pt-80">
          <div className="row align-items-center">
            ...
            {forms.banner.appliactionforCredittransfer.title}
              </h4>
              <h2>{forms.banner.appliactionforCredittransfer.titleTwo}</h2>
              <p className="banner-sub-descr">
              {forms.banner.appliactionforCredittransfer.descriptionOne}
              </p>
              <p className="sub-banner-cap">{forms.banner.appliactionforCredittransfer.descriptionTwo}</p>            </div>
