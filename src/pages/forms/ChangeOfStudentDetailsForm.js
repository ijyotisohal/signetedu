...
const ChangeOfStudentDetailsForm = () => {
  ...
  return (
    <>
      <Helmet>
<title>Change Of Student Details Form - Signet Institute of Australia</title>
<meta name='description' content='Update your student info seamlessly with our Change of Student Details Form. Keep your records accurate & up to date by submitting the form.'data-rh="true" />
</Helmet>
    <NewHeader/>
  ...
  <svg>
    ...
    <div className="outer-div pt--150">
      <Container>
            ...
            <div className="row address-div">
              ...
              >
                ...
                <Form.Select
                  ...
                  className="select-country col-md-6"
                >
                  <option>Please Select</option>
                  {JsonData.map((value) => {
                    return (
