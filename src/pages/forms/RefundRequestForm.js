...
const dispatch = useDispatch();
  ...
  return (
    <>
      <Helmet>
<title>Refund Request Form Submit Online | Signet Institute of Australia</title>
<meta name='description' content='Simplify your refund process online with our user-friendly Refund Request Form. Easily submit your details & Start refund process today.'data-rh="true" />
</Helmet>
        <NewHeader/>
      <div className="sub-course-banner pt--150">
       ...
       <div className="sub-banner-text pt-80">
          <div className="row">
            ...
            {forms.banner.refundRequest.title}
              </h4>
              <h2>{forms.banner.refundRequest.titleTwo}</h2>
              <p className="banner-sub-descr">
              {forms.banner.refundRequest.descriptionOne}
              </p>
              <p className="sub-banner-cap">{forms.banner.refundRequest.descriptionTwo}</p> 
            </div>
          ...
          <Form>
            ...
            {changePageState === true && (
              <>
                ...
                <Form.Group
                  // className="mb-3 col-md-3 col-md-3"
                  controlId="exampleForm.ControlInput1"
                >
                  <Form.Label>
